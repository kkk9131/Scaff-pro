...
export function EditOutlineIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function OpeningIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SnapIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ScaffoldIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function QuantityIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ZoomInIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ZoomOutIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function RulerIcon({ className, size = 20 }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M21.5 2.5L2.5 21.5" />
      <path d="M17.5 2.5L2.5 17.5" />
      <path d="M21.5 6.5L6.5 21.5" />
      <path d="M13.5 2.5L2.5 13.5" />
      <path d="M21.5 10.5L10.5 21.5" />
      <path d="M9.5 2.5L2.5 9.5" />
      <path d="M21.5 14.5L14.5 21.5" />
      <path d="M5.5 2.5L2.5 5.5" />
      <path d="M21.5 18.5L18.5 21.5" />
    </svg>
  );
}
